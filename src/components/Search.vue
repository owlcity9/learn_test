<template>
    <div id="search">
        <div id="div_3_3_1"></div>
        <!-- <div id="div_3_3_2"></div> -->
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        customNodeLink() {
            var nodeMap = { nodes: [], edges: { source: [], target: [] } };
            ...
            G6.registerBehavior('click-add-node', {
                ...
                onClick(ev) {
                    ...
                    graph.addItem('node', {
                        ...
                        y: ev.canvasY,
                        label: addedCount,
                        id: `n${addedCount}`, // Generate the unique id
                    });
                    //let node=graph.findById('node-'+addedCount);
                    //console.log(node);
                    addedCount++;
                },
            });
            ...
            // Initial data
            const container = document.getElementById('div_3_3_1');
